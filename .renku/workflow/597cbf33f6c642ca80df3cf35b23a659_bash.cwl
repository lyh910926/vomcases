...
inputs:
  ...
  input_2:
    ...
    type: Directory
  input_3:
    default: work/HowardSprings/freedrainage_cpcff10.0/input
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: File
      path: ../../work/HowardSprings/freedrainage_cpcff10.0/vom_namelist
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
    ...
    type: File
  input_7:
    default: data/VOM_output/HowardSprings/freedrainage_cpcff10.0/sce
    inputBinding:
      position: 7
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_6)
    entryname: work/HowardSprings/freedrainage_cpcff10.0/vom_namelist
    writable: false
successCodes: []
temporaryFailCodes: []
