...
inputs:
  ...
  input_3:
    default:
      class: Directory
      listing: []
      path: ../../work/DryRiver/freedrainage_cpcff1.6/input
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_3)
    entryname: work/DryRiver/freedrainage_cpcff1.6/input
    writable: false
  ...
  - entry: $(inputs.input_6)
    entryname: work/DryRiver/freedrainage_cpcff1.6/vom_namelist
    writable: false
successCodes: []
temporaryFailCodes: []
