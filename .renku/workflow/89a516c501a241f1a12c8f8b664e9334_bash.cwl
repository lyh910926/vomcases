...
inputs:
  ...
  input_3:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_input/HowardSprings
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
    ...
    type: Directory
  input_4:
    default: data/VOM_output/additional_analyses/sens_delz/HS_0.05/sce4
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
  ...
  input_5:
    default:
      class: File
      path: ../../work/additional_analyses/sens_delz/HS_0.05/vom_namelist
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/additional_analyses/sens_delz/HS_0.05/sce3
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
