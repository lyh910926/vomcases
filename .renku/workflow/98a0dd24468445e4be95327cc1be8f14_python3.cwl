...
inputs:
  ...
  input_16:
    ...
    type: int
  input_17:
    default: data/VOM_output/HowardSprings/freedrainage_cpcff0.2/sce_stats_best
    inputBinding:
      position: 17
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/HowardSprings/freedrainage_cpcff0.2/sce_stats_best
    writable: true
