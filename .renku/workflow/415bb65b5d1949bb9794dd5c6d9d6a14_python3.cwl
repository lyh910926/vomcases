...
inputs:
  ...
  input_29:
    ...
    type: File
  input_3:
    default: data/VOM_output/DryRiver/nofreedrainage_cpcff2.2/sce_stats
    inputBinding:
      position: 3
      prefix: -o
      separate: true
  ...
  input_5:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/DryRiver/nofreedrainage_cpcff2.2/sce_best
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/DryRiver/nofreedrainage_cpcff2.2/sce_stats
    writable: true
successCodes: []
temporaryFailCodes: []
