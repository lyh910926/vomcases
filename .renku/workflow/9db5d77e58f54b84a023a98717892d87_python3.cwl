...
inputs:
  ...
  input_29:
    ...
    type: File
  input_3:
    default: data/VOM_output/additional_analyses/sens_delz/HS_0.30/sce_stats
    inputBinding:
      position: 3
      prefix: -o
      separate: true
  ...
  input_7:
    default:
      class: Directory
      listing: []
      path: ../../work/additional_analyses/sens_delz/HS_0.30/best
    inputBinding:
      position: 7
      prefix: -w
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/additional_analyses/sens_delz/HS_0.30/sce_stats
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/additional_analyses/sens_delz/HS_0.30/sce_best
    writable: true
successCodes: []
temporaryFailCodes: []
