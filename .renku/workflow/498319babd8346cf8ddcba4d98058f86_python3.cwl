...
inputs:
  ...
  input_6:
    ...
    type: string
  input_7:
    default: work/additional_analyses/prescribed_cover/DryRiver/best/input/perc_cov.txt
    inputBinding:
      position: 7
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: work/additional_analyses/prescribed_cover/DryRiver/best/input
    writable: true
