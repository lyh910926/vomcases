...
inputs:
  ...
  input_6:
    ...
    type: string
  input_7:
    default: work/additional_analyses/deep_soils/DalyUncleared/freedrainage_cpcff2.8/best/input/dailyweather.prn
    inputBinding:
      position: 7
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: work/additional_analyses/deep_soils/DalyUncleared/freedrainage_cpcff2.8/best/input
    writable: true
