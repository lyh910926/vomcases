...
inputs:
  ...
  input_3:
    default:
      class: Directory
      listing: []
      path: ../../work/HowardSprings/freedrainage_cpcff1.0/input
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
  ...
  input_6:
    ...
    type: File
  input_7:
    default: data/VOM_output/HowardSprings/freedrainage_cpcff1.0/sce2
    inputBinding:
      position: 7
      separate: true
      shellQuote: true
  ...
  input_8:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/HowardSprings/freedrainage_cpcff1.0/sce
    inputBinding:
      position: 8
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_3)
    entryname: work/HowardSprings/freedrainage_cpcff1.0/input
    writable: false
  ...
  - entry: $(inputs.input_8)
    entryname: data/VOM_output/HowardSprings/freedrainage_cpcff1.0/sce
    writable: false
successCodes: []
temporaryFailCodes: []
