...
inputs:
  ...
  input_3:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_input/AdelaideRiver
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
    ...
    type: Directory
  input_4:
    default: data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.8/sce2
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
  ...
  input_5:
    default:
      class: File
      path: ../../work/AdelaideRiver/nofreedrainage_cpcff1.8/vom_namelist
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.8/sce
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
