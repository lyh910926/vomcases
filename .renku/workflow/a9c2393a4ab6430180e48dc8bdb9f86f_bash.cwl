...
inputs:
  ...
  input_2:
    default:
      class: Directory
      listing: []
      path: ../../work/HowardSprings/freedrainage_cpcff1.0
    inputBinding:
      position: 2
      separate: true
      shellQuote: true
...
outputs:
  output_0:
    outputBinding:
      glob: data/VOM_output/HowardSprings/freedrainage_cpcff1.0/sce_progress.txt
    streamable: false
    type: File
  output_1:
    outputBinding:
      glob: data/VOM_output/HowardSprings/freedrainage_cpcff1.0/sce_out.txt
    streamable: false
    type: File
  output_2:
    outputBinding:
      glob: data/VOM_output/HowardSprings/freedrainage_cpcff1.0/sce_lastloop.txt
    streamable: false
    type: File
  output_3:
    outputBinding:
      glob: data/VOM_output/HowardSprings/freedrainage_cpcff1.0/sce_status.txt
    streamable: false
    type: File
permanentFailCodes: []
requirements:
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/HowardSprings/freedrainage_cpcff1.0
    writable: true
successCodes: []
temporaryFailCodes: []
