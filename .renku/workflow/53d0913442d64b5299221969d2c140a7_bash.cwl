...
inputs:
  ...
  input_3:
    ...
    type: Directory
  input_4:
    default: data/VOM_output/SturtPlains/nofreedrainage_cpcff2.6/sce2
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
  ...
  input_5:
    default:
      class: File
      path: ../../work/SturtPlains/nofreedrainage_cpcff2.6/vom_namelist
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/SturtPlains/nofreedrainage_cpcff2.6/sce
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
