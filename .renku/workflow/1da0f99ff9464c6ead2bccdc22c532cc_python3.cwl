...
inputs:
  ...
  input_28:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/BESS/AdelaideRiver
    inputBinding:
      position: 28
      prefix: --out_bess
      separate: true
  ...
  input_29:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/BIOS2/AdelaideRiver
    inputBinding:
      position: 29
      prefix: --out_bios2
      separate: true
  ...
  input_30:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/LPJGUESS/AdelaideRiver
    inputBinding:
      position: 30
      prefix: --out_lpjguess
      separate: true
  ...
  input_31:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/MAESPA/AdelaideRiver
    inputBinding:
      position: 31
      prefix: --out_maespa
      separate: true
  ...
  input_32:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/SPA/AdelaideRiver
    inputBinding:
      position: 32
      prefix: --out_spa
      separate: true
  ...
  input_33:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/CABLE/AdelaideRiver
    inputBinding:
      position: 33
      prefix: --out_cable
      separate: true
  ...
  input_5:
    default:
      class: File
      path: ../../data/emp_benchmarks/emp2_ade
    inputBinding:
      position: 5
      prefix: --emp2
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_5)
    entryname: data/emp_benchmarks/emp2_ade
    writable: false
