...
inputs:
  ...
  input_4:
    default:
      class: File
      path: ../../work/DryRiver/freedrainage_cpcff1.2/best_10p/vom_namelist
    inputBinding:
      position: 4
      prefix: -n
      separate: true
  ...
  input_5:
    default:
      class: Directory
      listing: []
      path: ../../work/DryRiver/freedrainage_cpcff1.2/best_10p
    inputBinding:
      position: 5
      prefix: -w
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_4)
    entryname: work/DryRiver/freedrainage_cpcff1.2/best_10p/vom_namelist
    writable: false
