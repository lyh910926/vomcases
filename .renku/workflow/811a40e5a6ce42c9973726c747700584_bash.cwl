...
inputs:
  ...
  input_2:
    ...
    type: Directory
  input_3:
    default: work/additional_analyses/deep_soils/AdelaideRiver/freedrainage_cpcff1.4/input
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: File
      path: ../../work/additional_analyses/deep_soils/AdelaideRiver/freedrainage_cpcff1.4/vom_namelist
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
    ...
    type: File
  input_7:
    default: data/VOM_output/additional_analyses/deep_soils/AdelaideRiver/freedrainage_cpcff1.4/sce
    inputBinding:
      position: 7
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_6)
    entryname: work/additional_analyses/deep_soils/AdelaideRiver/freedrainage_cpcff1.4/vom_namelist
    writable: false
successCodes: []
temporaryFailCodes: []
