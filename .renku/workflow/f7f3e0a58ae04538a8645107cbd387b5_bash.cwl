...
inputs:
  ...
  input_2:
    ...
    type: Directory
  input_3:
    default: work/additional_analyses/sens_delz/HS_0.25/input
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
  ...
  input_5:
    default:
      class: File
      path: ../../work/additional_analyses/sens_delz/HS_0.25/vom_namelist
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
    ...
    type: File
  input_6:
    default: data/VOM_output/additional_analyses/sens_delz/HS_0.25/sce
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_5)
    entryname: work/additional_analyses/sens_delz/HS_0.25/vom_namelist
    writable: false
successCodes: []
temporaryFailCodes: []
