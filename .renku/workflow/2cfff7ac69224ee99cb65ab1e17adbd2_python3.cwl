...
inputs:
  ...
  input_12:
    ...
    type: int
  input_13:
    default: data/VOM_output/additional_analyses/prescribed_cover/SturtPlains/sce_stats_best
    inputBinding:
      position: 13
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/additional_analyses/prescribed_cover/SturtPlains/sce_stats_best
    writable: true
successCodes: []
temporaryFailCodes: []
