...
inputs:
  ...
  input_6:
    ...
    type: File
  input_7:
    default: data/VOM_output/additional_analyses/sens_cgs/HS_2/sce2
    inputBinding:
      position: 7
      separate: true
      shellQuote: true
  ...
  input_8:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/additional_analyses/sens_cgs/HS_2/sce
    inputBinding:
      position: 8
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_8)
    entryname: data/VOM_output/additional_analyses/sens_cgs/HS_2/sce
    writable: false
successCodes: []
temporaryFailCodes: []
