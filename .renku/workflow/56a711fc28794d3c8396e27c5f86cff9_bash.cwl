...
inputs:
  ...
  input_2:
    ...
    type: Directory
  input_3:
    default: work/DryRiver/freedrainage_cpcff2.0/input
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
  ...
  input_6:
    ...
    type: File
  input_7:
    default: data/VOM_output/DryRiver/freedrainage_cpcff2.0/sce
    inputBinding:
      position: 7
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_6)
    entryname: work/DryRiver/freedrainage_cpcff2.0/vom_namelist
    writable: false
successCodes: []
temporaryFailCodes: []
