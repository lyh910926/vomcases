...
inputs:
  ...
  input_2:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/sens_cgs/HS_15/sce/sce_out.txt
    inputBinding:
      position: 2
      prefix: -i
      separate: true
  ...
  input_29:
    ...
    type: File
  input_3:
    default: data/VOM_output/additional_analyses/sens_cgs/HS_15/sce_stats
    inputBinding:
      position: 3
      prefix: -o
      separate: true
  ...
  input_7:
    default:
      class: Directory
      listing: []
      path: ../../work/additional_analyses/sens_cgs/HS_15/best
    inputBinding:
      position: 7
      prefix: -w
      separate: true
