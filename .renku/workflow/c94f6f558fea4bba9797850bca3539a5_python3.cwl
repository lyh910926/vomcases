...
inputs:
  ...
  input_29:
    ...
    type: File
  input_3:
    default: data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.2/sce_stats
    inputBinding:
      position: 3
      prefix: -o
      separate: true
  ...
  input_4:
    ...
    type: string
  input_5:
    default: data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.2/sce_best
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: File
      path: ../../work/AdelaideRiver/nofreedrainage_cpcff1.2/best/vom_namelist
    inputBinding:
      position: 6
      prefix: -n
      separate: true
