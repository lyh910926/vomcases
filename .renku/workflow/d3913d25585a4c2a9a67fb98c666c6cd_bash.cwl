...
inputs:
  ...
  input_3:
    default:
      class: Directory
      listing: []
      path: ../../work/AdelaideRiver/freedrainage_cpcff0.6/input
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: File
      path: ../../work/AdelaideRiver/freedrainage_cpcff0.6/vom_namelist
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
    ...
    type: File
  input_7:
    default: data/VOM_output/AdelaideRiver/freedrainage_cpcff0.6/sce
    inputBinding:
      position: 7
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_3)
    entryname: work/AdelaideRiver/freedrainage_cpcff0.6/input
    writable: false
  ...
  - entry: $(inputs.input_6)
    entryname: work/AdelaideRiver/freedrainage_cpcff0.6/vom_namelist
    writable: false
successCodes: []
temporaryFailCodes: []
