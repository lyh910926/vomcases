...
inputs:
  ...
  input_27:
    ...
    type: File
  input_28:
    default: data/SavMIP_stats/BESS/DryRiver
    inputBinding:
      position: 28
      prefix: --out_bess
      separate: true
    ...
    type: string
  input_29:
    default: data/SavMIP_stats/BIOS2/DryRiver
    inputBinding:
      position: 29
      prefix: --out_bios2
      separate: true
  ...
  input_3:
    default:
      class: File
      path: ../../data/emp_benchmarks/emp1_dry
    inputBinding:
      position: 3
      prefix: --emp1
      separate: true
    ...
    type: File
  input_30:
    default: data/SavMIP_stats/LPJGUESS/DryRiver
    inputBinding:
      position: 30
      prefix: --out_lpjguess
      separate: true
    ...
    type: string
  input_31:
    default: data/SavMIP_stats/MAESPA/DryRiver
    inputBinding:
      position: 31
      prefix: --out_maespa
      separate: true
    ...
    type: string
  input_32:
    default: data/SavMIP_stats/SPA/DryRiver
    inputBinding:
      position: 32
      prefix: --out_spa
      separate: true
    ...
    type: string
  input_33:
    default: data/SavMIP_stats/CABLE/DryRiver
    inputBinding:
      position: 33
      prefix: --out_cable
      separate: true
  ...
  input_34:
    ...
    type: string
  input_35:
    default: data/emp_benchmarks/stats_emp1/DryRiver
    inputBinding:
      position: 35
      prefix: --out_emp1
      separate: true
    ...
    type: string
  input_36:
    default: data/emp_benchmarks/stats_emp2/DryRiver
    inputBinding:
      position: 36
      prefix: --out_emp2
      separate: true
  ...
  input_4:
    default:
      class: File
      path: ../../data/emp_benchmarks/emp1_gpp_dry
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
  ...
  input_5:
    default:
      class: File
      path: ../../data/emp_benchmarks/emp2_dry
    inputBinding:
      position: 5
      prefix: --emp2
      separate: true
  ...
  input_6:
    default:
      class: File
      path: ../../data/emp_benchmarks/emp2_gpp_dry
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/SavMIP_stats/BESS/DryRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/SavMIP_stats/BIOS2/DryRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/SavMIP_stats/LPJGUESS/DryRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/SavMIP_stats/MAESPA/DryRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/SavMIP_stats/SPA/DryRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/SavMIP_stats/CABLE/DryRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/emp_benchmarks/stats_emp1/DryRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/emp_benchmarks/stats_emp2/DryRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
  ...
  - entry: $(inputs.input_3)
    entryname: data/emp_benchmarks/emp1_dry
    writable: false
  - entry: $(inputs.input_4)
    entryname: data/emp_benchmarks/emp1_gpp_dry
    writable: false
  - entry: $(inputs.input_5)
    entryname: data/emp_benchmarks/emp2_dry
    writable: false
  - entry: $(inputs.input_6)
    entryname: data/emp_benchmarks/emp2_gpp_dry
    writable: false
