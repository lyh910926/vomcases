...
inputs:
  ...
  input_15:
    default:
      class: Directory
      listing: []
      path: ../../work/AdelaideRiver/nofreedrainage_cpcff1.2/best
    inputBinding:
      position: 15
      prefix: -w
      separate: true
  ...
  input_2:
    default:
      class: File
      path: ../../data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.2/sce_out.txt
    inputBinding:
      position: 2
      prefix: -i
      separate: true
  ...
  input_21:
    ...
    type: File
  input_3:
    default: data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.2/bestruns
    inputBinding:
      position: 3
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    ...
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.2/bestruns
    writable: true
successCodes: []
temporaryFailCodes: []
