...
inputs:
  ...
  input_29:
    ...
    type: File
  input_3:
    default: data/VOM_output/SturtPlains/nofreedrainage_cpcff0.2/sce_stats
    inputBinding:
      position: 3
      prefix: -o
      separate: true
  ...
  input_6:
    default:
      class: File
      path: ../../work/SturtPlains/nofreedrainage_cpcff0.2/best/vom_namelist
    inputBinding:
      position: 6
      prefix: -n
      separate: true
  ...
  input_7:
    default:
      class: Directory
      listing: []
      path: ../../work/SturtPlains/nofreedrainage_cpcff0.2/best
    inputBinding:
      position: 7
      prefix: -w
      separate: true
