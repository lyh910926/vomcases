...
inputs:
  ...
  input_123:
    default:
      class: File
      path: ../../data/VOM_output/Litchfield/freedrainage_cpcff1.0/sce_stats_best/ass_beststats.txt
    inputBinding:
      position: 123
      separate: true
      shellQuote: true
  ...
  input_129:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/prescribed_cover/Litchfield/sce_stats_best/ass_beststats.txt
    inputBinding:
      position: 129
      separate: true
      shellQuote: true
  ...
  input_135:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/prescribed_cover2/Litchfield/sce_stats_best/ass_beststats.txt
    inputBinding:
      position: 135
      separate: true
      shellQuote: true
  ...
  input_141:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/fixed_roots/Litchfield/sce_stats_best/ass_beststats.txt
    inputBinding:
      position: 141
      separate: true
      shellQuote: true
  ...
  input_69:
    default:
      class: File
      path: ../../data/VOM_output/Litchfield/freedrainage_cpcff1.0/sce_stats_best/evap_beststats.txt
    inputBinding:
      position: 69
      separate: true
      shellQuote: true
  ...
  input_75:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/prescribed_cover/Litchfield/sce_stats_best/evap_beststats.txt
    inputBinding:
      position: 75
      separate: true
      shellQuote: true
  ...
  input_81:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/prescribed_cover2/Litchfield/sce_stats_best/evap_beststats.txt
    inputBinding:
      position: 81
      separate: true
      shellQuote: true
  ...
  input_87:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/fixed_roots/Litchfield/sce_stats_best/evap_beststats.txt
    inputBinding:
      position: 87
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_69)
    entryname: data/VOM_output/Litchfield/freedrainage_cpcff1.0/sce_stats_best/evap_beststats.txt
    writable: false
  ...
  - entry: $(inputs.input_75)
    entryname: data/VOM_output/additional_analyses/prescribed_cover/Litchfield/sce_stats_best/evap_beststats.txt
    writable: false
  ...
  - entry: $(inputs.input_81)
    entryname: data/VOM_output/additional_analyses/prescribed_cover2/Litchfield/sce_stats_best/evap_beststats.txt
    writable: false
  ...
  - entry: $(inputs.input_87)
    entryname: data/VOM_output/additional_analyses/fixed_roots/Litchfield/sce_stats_best/evap_beststats.txt
    writable: false
  ...
  - entry: $(inputs.input_123)
    entryname: data/VOM_output/Litchfield/freedrainage_cpcff1.0/sce_stats_best/ass_beststats.txt
    writable: false
  ...
  - entry: $(inputs.input_129)
    entryname: data/VOM_output/additional_analyses/prescribed_cover/Litchfield/sce_stats_best/ass_beststats.txt
    writable: false
  ...
  - entry: $(inputs.input_135)
    entryname: data/VOM_output/additional_analyses/prescribed_cover2/Litchfield/sce_stats_best/ass_beststats.txt
    writable: false
  ...
  - entry: $(inputs.input_141)
    entryname: data/VOM_output/additional_analyses/fixed_roots/Litchfield/sce_stats_best/ass_beststats.txt
    writable: false
