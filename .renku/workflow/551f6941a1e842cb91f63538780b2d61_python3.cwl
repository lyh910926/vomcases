...
inputs:
  ...
  input_2:
    default:
      class: File
      path: ../../data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.6/sce/sce_out.txt
    inputBinding:
      position: 2
      prefix: -i
      separate: true
  ...
  input_29:
    ...
    type: File
  input_3:
    default: data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.6/sce_stats
    inputBinding:
      position: 3
      prefix: -o
      separate: true
  ...
  input_4:
    ...
    type: string
  input_5:
    default: data/VOM_output/AdelaideRiver/nofreedrainage_cpcff1.6/sce_best
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: File
      path: ../../work/AdelaideRiver/nofreedrainage_cpcff1.6/best/vom_namelist
    inputBinding:
      position: 6
      prefix: -n
      separate: true
  ...
  input_7:
    default:
      class: Directory
      listing: []
      path: ../../work/AdelaideRiver/nofreedrainage_cpcff1.6/best
    inputBinding:
      position: 7
      prefix: -w
      separate: true
