...
inputs:
  ...
  input_6:
    ...
    type: string
  input_7:
    default: work/additional_analyses/no_treecover/SturtPlains/pc_prescribed/input/perc_cov.txt
    inputBinding:
      position: 7
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: work/additional_analyses/no_treecover/SturtPlains/pc_prescribed/input
    writable: true
