...
inputs:
  ...
  input_3:
    ...
    type: Directory
  input_4:
    default: data/VOM_output/Litchfield/freedrainage_cpcff1.4/sce3
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
  ...
  input_5:
    default:
      class: File
      path: ../../work/Litchfield/freedrainage_cpcff1.4/vom_namelist
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/Litchfield/freedrainage_cpcff1.4/sce2
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
