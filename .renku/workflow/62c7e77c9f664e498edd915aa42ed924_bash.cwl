...
inputs:
  ...
  input_5:
    ...
    type: File
  input_6:
    default: data/VOM_output/additional_analyses/comp2015/1_benchmark_repr/sce_best
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/additional_analyses/comp2015/1_benchmark_repr/sce_best
    writable: true
  ...
  - entry: $(inputs.input_5)
    entryname: work/additional_analyses/comp2015/1_benchmark_repr/vom_namelist
    writable: false
successCodes: []
temporaryFailCodes: []
