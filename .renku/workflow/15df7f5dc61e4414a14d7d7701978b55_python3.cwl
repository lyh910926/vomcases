...
inputs:
  ...
  input_2:
    default:
      class: File
      path: ../../data/VOM_output/DalyUncleared/freedrainage_cpcff1.0/sce_out.txt
    inputBinding:
      position: 2
      prefix: -i
      separate: true
  ...
  input_22:
    ...
    type: int
  input_23:
    default: data/VOM_output/DalyUncleared/freedrainage_cpcff1.0/bestruns/resultsdaily_max.txt
    inputBinding:
      position: 23
      separate: true
      shellQuote: true
  ...
  input_24:
    ...
    type: int
  input_25:
    default: data/VOM_output/DalyUncleared/freedrainage_cpcff1.0/bestruns/resultsdaily_min.txt
    inputBinding:
      position: 25
      separate: true
      shellQuote: true
  ...
  input_3:
    default:
      class: Directory
      listing: []
      path: ../../work/DalyUncleared/freedrainage_cpcff1.0/best
    inputBinding:
      position: 3
      prefix: -w
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/DalyUncleared/freedrainage_cpcff1.0/bestruns
    writable: true
successCodes: []
temporaryFailCodes: []
