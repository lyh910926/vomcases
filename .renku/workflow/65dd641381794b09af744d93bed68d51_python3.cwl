...
inputs:
  ...
  input_2:
    default:
      class: File
      path: ../../data/VOM_output/HowardSprings/freedrainage_cpcff1.0/sce_out.txt
    inputBinding:
      position: 2
      prefix: -i
      separate: true
  ...
  input_21:
    ...
    type: File
  input_22:
    default: data/VOM_output/HowardSprings/freedrainage_cpcff1.0/bestruns/resultsdaily_best.txt
    inputBinding:
      position: 22
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/HowardSprings/freedrainage_cpcff1.0/bestruns
    writable: true
successCodes: []
temporaryFailCodes: []
