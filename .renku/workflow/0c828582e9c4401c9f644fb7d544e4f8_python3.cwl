...
inputs:
  ...
  input_10:
    default:
      class: File
      path: ../../work/additional_analyses/prescribed_cover/AdelaideRiver/input/perc_cov.txt
    inputBinding:
      position: 10
      separate: true
      shellQuote: true
  ...
  input_2:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/prescribed_cover/AdelaideRiver/sce/sce_out.txt
    inputBinding:
      position: 2
      prefix: -i
      separate: true
  ...
  input_29:
    ...
    type: File
  input_3:
    default: data/VOM_output/additional_analyses/prescribed_cover/AdelaideRiver/sce_stats
    inputBinding:
      position: 3
      prefix: -o
      separate: true
  ...
  input_7:
    default:
      class: Directory
      listing: []
      path: ../../work/additional_analyses/prescribed_cover/AdelaideRiver/best
    inputBinding:
      position: 7
      prefix: -w
      separate: true
