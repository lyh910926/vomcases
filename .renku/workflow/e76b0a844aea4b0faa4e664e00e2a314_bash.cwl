...
inputs:
  ...
  input_3:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_input/HowardSprings/11_hydro2
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
    ...
    type: Directory
  input_4:
    default: data/VOM_output/additional_analyses/comp2015/11_hydro2/sce
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
  ...
  input_5:
    default:
      class: File
      path: ../../work/additional_analyses/comp2015/11_hydro2/vom_namelist
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
