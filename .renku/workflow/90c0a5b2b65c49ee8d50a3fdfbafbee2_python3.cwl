...
inputs:
  ...
  input_3:
    default:
      class: File
      path: ../../data/emp_benchmarks/emp1_ade
    inputBinding:
      position: 3
      prefix: --emp1
      separate: true
  ...
  input_34:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/AdelaideRiver/freedrainage_cpcff1.0/sce_stats_best
    inputBinding:
      position: 34
      prefix: --out_vom
      separate: true
    ...
    type: Directory
  input_35:
    default: data/emp_benchmarks/stats_emp1/AdelaideRiver
    inputBinding:
      position: 35
      prefix: --out_emp1
      separate: true
    ...
    type: string
  input_36:
    default: data/emp_benchmarks/stats_emp2/AdelaideRiver
    inputBinding:
      position: 36
      prefix: --out_emp2
      separate: true
  ...
  input_4:
    default:
      class: File
      path: ../../data/emp_benchmarks/emp1_gpp_ade
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: File
      path: ../../data/emp_benchmarks/emp2_gpp_ade
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    ...
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/emp_benchmarks/stats_emp1/AdelaideRiver
    writable: true
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/emp_benchmarks/stats_emp2/AdelaideRiver
    writable: true
  ...
  - entry: $(inputs.input_3)
    entryname: data/emp_benchmarks/emp1_ade
    writable: false
  - entry: $(inputs.input_4)
    entryname: data/emp_benchmarks/emp1_gpp_ade
    writable: false
  - entry: $(inputs.input_5)
    entryname: data/emp_benchmarks/emp2_dal
    writable: false
  - entry: $(inputs.input_6)
    entryname: data/emp_benchmarks/emp2_gpp_ade
    writable: false
