...
inputs:
  ...
  input_16:
    ...
    type: File
  input_17:
    default: data/VOM_output/additional_analyses/prescribed_cover2/Litchfield/sce_stats_best
    inputBinding:
      position: 17
      prefix: -o
      separate: true
  ...
  input_2:
    default:
      class: File
      path: ../../data/VOM_output/additional_analyses/prescribed_cover2/Litchfield/sce_best/results_daily.txt
    inputBinding:
      position: 2
      prefix: -i
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/additional_analyses/prescribed_cover2/Litchfield/sce_stats_best
    writable: true
  - entry: $(inputs.input_1)
    entryname: src_py/sce_stats_best.py
    writable: false
  - entry: $(inputs.input_2)
    entryname: data/VOM_output/additional_analyses/prescribed_cover2/Litchfield/sce_best/results_daily.txt
    writable: false
