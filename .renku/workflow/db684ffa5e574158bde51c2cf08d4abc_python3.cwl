...
inputs:
  ...
  input_23:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/BESS/SturtPlains
    inputBinding:
      position: 23
      prefix: --out_bess
      separate: true
  ...
  input_24:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/BIOS2/SturtPlains
    inputBinding:
      position: 24
      prefix: --out_bios2
      separate: true
  ...
  input_25:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/LPJGUESS/SturtPlains
    inputBinding:
      position: 25
      prefix: --out_lpjguess
      separate: true
  ...
  input_26:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/MAESPA/SturtPlains
    inputBinding:
      position: 26
      prefix: --out_maespa
      separate: true
  ...
  input_27:
    default:
      class: Directory
      listing: []
      path: ../../data/SavMIP_stats/SPA/SturtPlains
    inputBinding:
      position: 27
      prefix: --out_spa
      separate: true
