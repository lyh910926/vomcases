...
inputs:
  input_1:
    default:
      class: File
      path: ../../src_py/write_pcseries_add_const.py
    inputBinding:
      position: 1
      separate: true
      shellQuote: true
  ...
  input_6:
    ...
    type: string
  input_7:
    default: work/additional_analyses/prescribed_cover/SturtPlains/input/perc_cov.txt
    inputBinding:
      position: 7
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_1)
    entryname: src_py/write_pcseries_add_const.py
    writable: false
