...
inputs:
  ...
  input_5:
    ...
    type: File
  input_6:
    default: work/additional_analyses/sens_weatherdata/2_dingo_sce/best/input/dailyweather.prn
    inputBinding:
      position: 6
      prefix: -o
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_1)
    entryname: src_py/dingo_dailyweather.py
    writable: false
  ...
  - entry: $(inputs.input_7)
    entryname: data/DINGO2/Tmax_howard.txt
    writable: false
  - entry: $(inputs.input_8)
    entryname: data/DINGO2/Tmin_howard.txt
    writable: false
  - entry: $(inputs.input_9)
    entryname: data/DINGO2/Prec_howard.txt
    writable: false
  - entry: $(inputs.input_10)
    entryname: data/DINGO2/Fsd_howard.txt
    writable: false
  - entry: $(inputs.input_11)
    entryname: data/DINGO2/VP_howard.txt
    writable: false
  - entry: $(inputs.input_12)
    entryname: data/DINGO2/Pres_howard.txt
    writable: false
successCodes: []
temporaryFailCodes: []
