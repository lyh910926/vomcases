...
inputs:
  ...
  input_3:
    default:
      class: Directory
      listing: []
      path: ../../work/Litchfield/nofreedrainage_cpcff1.8/params_f1.8/input
    inputBinding:
      position: 3
      separate: true
      shellQuote: true
    ...
    type: Directory
  input_4:
    default: data/VOM_output/Litchfield/nofreedrainage_cpcff1.8/params_f
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: '$({"listing": [], "class": "Directory"})'
    entryname: data/VOM_output/Litchfield/nofreedrainage_cpcff1.8/params_f
    writable: true
