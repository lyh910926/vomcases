...
inputs:
  ...
  input_2:
    default:
      class: File
      path: ../../data/VOM_output/AdelaideRiver/freedrainage_cpcff1.2/sce/sce_out.txt
    inputBinding:
      position: 2
      prefix: -i
      separate: true
  ...
  input_29:
    ...
    type: string
  input_3:
    default: data/VOM_output/AdelaideRiver/freedrainage_cpcff1.2/sce_stats
    inputBinding:
      position: 3
      prefix: -o
      separate: true
  ...
  input_4:
    default:
      class: File
      path: ../../work/AdelaideRiver/freedrainage_cpcff1.2/best_10p/vom_namelist
    inputBinding:
      position: 4
      prefix: -n
      separate: true
  ...
  input_5:
    default:
      class: Directory
      listing: []
      path: ../../work/AdelaideRiver/freedrainage_cpcff1.2/best_10p
    inputBinding:
      position: 5
      prefix: -w
      separate: true
...
- class: InitialWorkDirRequirement
  ...
  - entry: $(inputs.input_2)
    entryname: data/VOM_output/AdelaideRiver/freedrainage_cpcff1.2/sce/sce_out.txt
    writable: false
  - entry: $(inputs.input_4)
    entryname: work/AdelaideRiver/freedrainage_cpcff1.2/best_10p/vom_namelist
    writable: false
