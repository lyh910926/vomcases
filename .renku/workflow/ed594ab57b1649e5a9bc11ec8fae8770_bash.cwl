...
inputs:
  ...
  input_3:
    ...
    type: Directory
  input_4:
    default: data/VOM_output/Litchfield/nofreedrainage_cpcff1.0/sce2
    inputBinding:
      position: 4
      separate: true
      shellQuote: true
  ...
  input_5:
    default:
      class: File
      path: ../../work/Litchfield/nofreedrainage_cpcff1.0/vom_namelist
    inputBinding:
      position: 5
      separate: true
      shellQuote: true
  ...
  input_6:
    default:
      class: Directory
      listing: []
      path: ../../data/VOM_output/Litchfield/nofreedrainage_cpcff1.0/sce
    inputBinding:
      position: 6
      separate: true
      shellQuote: true
