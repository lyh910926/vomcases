...
def main():
    ...
    parser.add_argument("-e", "--evap_obs", help="inputfile with observations evaporation")
    parser.add_argument("-a", "--ass_obs", help="inputfile with observations assimilation")
