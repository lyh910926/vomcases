...
def main():
    ...
    file.write("parval0="+ args.o_lambdagf + " " + args.o_wsgexp + " " + args.o_lambdatf + " " + args.o_wstexp + " " + args.o_cai + " " + args.o_rtdepth + " " + args.o_mdstore + " " + args.i_cgs + " " + args.i_go + " " + args.i_ksat + " " + args.i_thetar + " " + args.i_thetas + " " + args.i_nvg + " " + args.i_avg + "\n" )
    file.write("parmin0="+ args.min_lambdagf + " " + args.min_wsgexp + " " + args.min_lambdatf + " " + args.min_wstexp + " " + args.min_cai + " " + args.min_rtdepth + " " + args.min_mdstore + " " + args.min_cgs + " " + args.min_go + " " + args.min_ksat + " " + args.min_thetar + " " + args.min_thetas + " " + args.min_nvg + " " + args.min_avg + "\n")
    file.write("parmax0="+ args.max_lambdagf + " " + args.max_wsgexp + " " + args.max_lambdatf + " " + args.max_wstexp + " " + args.max_cai + " " + args.max_rtdepth + " " + args.max_mdstore + " " + args.max_cgs + " " + args.max_go + " " + args.max_ksat + " " + args.max_thetar + " " + args.max_thetas + " " + args.max_nvg + " " + args.max_avg + "\n")
    file.write("paropt0="+ args.opt_lambdagf + " " + args.opt_wsgexp + " " + args.opt_lambdatf + " " + args.opt_wstexp + " " + args.opt_cai + " " + args.opt_rtdepth + " " + args.opt_mdstore + " " + args.opt_cgs + " " + args.opt_go + " " + args.opt_ksat + " " + args.opt_thetar + " " + args.opt_thetas + " " + args.opt_nvg + " " + args.opt_avg + "\n" )
    file.write("&end\n")
