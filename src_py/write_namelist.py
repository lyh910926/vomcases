...
def main():
    ...
    parser.add_argument("--i_read_pc", default="0", help="fraction of radiative energy reaching soil under full cover (0-1)")
    parser.add_argument("--i_trans_vegcov", default="0.2d0", help="flag to read vegetation coverage values from file")
    parser.add_argument("--i_lai_function", default="1", help="switch for 1) linear or 2) exponential function of LAI for foliage cost")
    parser.add_argument("--i_no_veg", default="0", help="switch for running VOM without vegetation (0-with, 1-without)")
    ...
    file.write("i_trans_vegcov="+ args.i_trans_vegcov + ", ! fraction of radiative energy reaching soil under full cover (0-1)\n")
    file.write("i_lai_function="+ args.i_lai_function + ",       ! switch for 1) linear or 2) exponential function of LAI for foliage cost\n")
    file.write("i_no_veg="+ args.i_no_veg + ",       ! switch for running VOM without vegetation (0-with, 1-without)\n")
