...
def main():
    ...
    parser.add_argument("--i_no_vegetation", default="0", help="switch for running VOM without vegetation (0-with, 1-without)")
    ...
    file.write("i_no_vegetation="+ args.i_no_vegetation + ",       ! switch for running VOM without vegetation (0-with, 1-without)\n")
