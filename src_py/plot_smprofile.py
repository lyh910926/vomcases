...
#***********************************************************************
#        plot_smprofile.py
#        Script to plot the time-averaged soil moisture profile of the VOM. 
#        
#-----------------------------------------------------------------------
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Script to plot the time-averaged soil moisture profile of the VOM.")
